...
import {
  ...
  yI,
  zr
} from "./chunk-L2ERUQPT.js";
import {
  gt,
  yn
} from "./chunk-YN6OSM23.js";
...
import {
  require_client
} from "./chunk-CRNLCER6.js";
import "./chunk-HMAD7BO2.js";
import "./chunk-4YXVI24W.js";
import {
  require_react
} from "./chunk-BZLBSB5M.js";
import {
  require_core_events
...
// ../../.yarn/__virtual__/@storybook-addon-docs-virtual-e63140a0ea/0/cache/@storybook-addon-docs-npm-8.4.7-78c31ff38c-0eb1854ddb.zip/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../.yarn/__virtual__/@storybook-blocks-virtual-cdf64b8a7c/0/cache/@storybook-blocks-npm-8.4.7-207aaa0972-1cb87811f9.zip/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-G46G5ROC.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-F6OSRLHC-YUGPTHUF.js"));
...
// ../../.yarn/__virtual__/@storybook-react-dom-shim-virtual-064d3ea696/0/cache/@storybook-react-dom-shim-npm-8.4.7-4a5a6f9b3e-5db1306c84.zip/node_modules/@storybook/react-dom-shim/dist/react-18.mjs
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-E3YQZH25.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-RY5YLREQ.js.map
